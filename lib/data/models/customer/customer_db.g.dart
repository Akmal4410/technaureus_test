...
class CustomerDBAdapter extends TypeAdapter<CustomerDB> {
  @override
  final int typeId = 1;

  @override
  CustomerDB read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, CustomerDB obj) {
    writer
      ..writeByte(16)
      ..writeByte(0)
      ..write(obj.id)
